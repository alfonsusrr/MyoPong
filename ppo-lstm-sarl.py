...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument("--log-dir", type=str, default=os.path.join("runs",
                      "ppo_lstm_sarl_tabletennis"), help="Log directory")
  ...
  parser.add_argument("--policy", type=str, default="MlpLstmPolicy",
                      help="Stable-Baselines3 policy (Recurrent)")
  ...
  parser.add_argument("--wandb-project", type=str, default="myosuite-ppo-lstm-sarl",
...
def main() -> None:
  ...
  try:
    ...
    final_save_path = args.save_path or os.path.join(
        log_dir, "ppo_lstm_sarl_tabletennis")
